...
class Bat(pygame.sprite.Sprite):
    ...
    def update(self, i):
        ...
        if pygame.sprite.spritecollideany(self, all_sprite_wall) or pygame.sprite.spritecollideany(
                self, all_sprite_thorns) or pygame.sprite.spritecollideany(self, all_sprite_shoter)or pygame.sprite.spritecollideany(self, exit_sprite):
            self.rect.x -= self.x
            self.x *= (-1)
...
class Monetka(pygame.sprite.Sprite):
    ...
    def count_monet(self):
        return self.i

    def clear_monrt(self):
        self.i = 0
